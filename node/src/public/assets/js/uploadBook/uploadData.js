...
// }
// else {
//   document.getElementById("bookForm").style.pointerEvents = "auto";
// }
...
$(document).ready(function () {
  ...
  // Enable/disable form based on token
  if (token && token !== "null" && token.trim() !== "") {
    bookForm.style.pointerEvents = "auto"; // normal clickable state
  } else {
    showErrorToast("Unauthorized. Please log in / sign up first. It takes a few seconds :)");
    bookForm.style.pointerEvents = "none"; // disables all clicks
  }
